...
public:
    ...
    void
    repropagate(const Eigen::Vector3d &_linearized_ba,
    ...
    void
    midPointIntegration(double _dt,
    ...
    evaluate(const Eigen::Vector3d &Pi,
    ...
    Eigen::aligned_vector<Eigen::Vector3d> acc_buf;
    Eigen::aligned_vector<Eigen::Vector3d> gyr_buf;
